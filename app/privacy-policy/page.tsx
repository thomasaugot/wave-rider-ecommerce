    ...
    <div className="container">
      ...
      <div className="container__content">
        ...
        <ul>
          ...
          <li>
            <strong>Payment Information:</strong> We collect data necessary to
            ...
            stored by our payment processor (e.g., Stripe) and you should review
            its privacy policies and contact the payment processor directly to
        ...
        <p>
          ...
          contact us at: thomas.augot@hotmail.fr
        </p>
      </div>
    </div>
  );
