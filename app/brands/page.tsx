...
const brands: Brand[] = [
  {
    name: "Aipa",
    imageUrl: aipa.src,
    redirectTo: "/products?search=" + encodeURIComponent("Aipa"),
  },
  {
    name: "Dakine",
    imageUrl: dakine.src,
    redirectTo: "/products?search=" + encodeURIComponent("Dakine"),
  },
  {
    name: "Funkshen",
    imageUrl: funkshen.src,
    redirectTo: "/products?search=" + encodeURIComponent("Funkshen"),
  },
  {
    name: "GoPro",
    imageUrl: gopro.src,
    redirectTo: "/products?search=" + encodeURIComponent("GoPro"),
  },
  {
    name: "Jaked",
    imageUrl: jaked.src,
    redirectTo: "/products?search=" + encodeURIComponent("Jaked"),
  },
  {
    name: "Loft Sails",
    imageUrl: loftsails.src,
    redirectTo: "/products?search=" + encodeURIComponent("Loft Sails"),
  },
  {
    name: "Mystic",
    imageUrl: mystic.src,
    redirectTo: "/products?search=" + encodeURIComponent("Mystic"),
  },
  {
    name: "Nomads",
    imageUrl: nomads.src,
    redirectTo: "/products?search=" + encodeURIComponent("Nomads"),
  },
  {
    name: "Ocean Storm",
    imageUrl: oceanStorm.src,
    redirectTo: "/products?search=" + encodeURIComponent("Ocean Storm"),
  },
  {
    name: "Peter Lynn",
    imageUrl: peterLynn.src,
    redirectTo: "/products?search=" + encodeURIComponent("Peter Lynn"),
  },
  {
    name: "Reflex",
    imageUrl: reflex.src,
    redirectTo: "/products?search=" + encodeURIComponent("Reflex"),
  },
  {
    name: "Rip Curl",
    imageUrl: ripcurl.src,
    redirectTo: "/products?search=" + encodeURIComponent("Rip Curl"),
  },
  {
    name: "Ryder",
    imageUrl: ryder.src,
    redirectTo: "/products?search=" + encodeURIComponent("Ryder"),
  },
  {
    name: "Softech",
    imageUrl: softech.src,
    redirectTo: "/products?search=" + encodeURIComponent("Softech"),
  },
  {
    name: "Surfica",
    imageUrl: surfica.src,
    redirectTo: "/products?search=" + encodeURIComponent("Surfica"),
  },
  {
    name: "Xcel",
    imageUrl: xcel.src,
    redirectTo: "/products?search=" + encodeURIComponent("Xcel"),
  },
  {
    name: "Billabong",
    imageUrl: billabong.src,
    redirectTo: "/products?search=" + encodeURIComponent("Billabong"),
  },
  {
    name: "Quiksilver",
    imageUrl: quiksilver.src,
    redirectTo: "/products?search=" + encodeURIComponent("Quiksilver"),
  },
  {
    name: "Roxy",
    imageUrl: roxy.src,
    redirectTo: "/products?search=" + encodeURIComponent("Roxy"),
  },
  {
    name: "Volcom",
    imageUrl: volcom.src,
    redirectTo: "/products?search=" + encodeURIComponent("Volcom"),
  },
  {
    name: "Rusty",
    imageUrl: rusty.src,
    redirectTo: "/products?search=" + encodeURIComponent("Rusty"),
  },
  {
    name: "Hurley",
    imageUrl: hurley.src,
    redirectTo: "/products?search=" + encodeURIComponent("Hurley"),
  },
  {
    name: "Vissla",
    imageUrl: vissla.src,
    redirectTo: "/products?search=" + encodeURIComponent("Vissla"),
  },
  {
    name: "Patagonia",
    imageUrl: patagonia.src,
    redirectTo: "/products?search=" + encodeURIComponent("Patagonia"),
  },
  {
    name: "RVCA",
    imageUrl: rvca.src,
    redirectTo: "/products?search=" + encodeURIComponent("RVCA"),
  },
  {
    name: "Element",
    imageUrl: element.src,
    redirectTo: "/products?search=" + encodeURIComponent("Element"),
  },
  {
    name: "O'Neill",
    imageUrl: oneill.src,
    redirectTo: "/products?search=" + encodeURIComponent("O'Neill"),
  },
];
