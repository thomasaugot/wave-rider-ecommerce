  ...
  return (
    <div className="terms">
      ...
      <div className="terms__content">
        ...
        <p>
          This Site is for training and educational purposes only. The content,
          including but not limited to articles, images, and other materials
          found online and used on this Site, are for personal project
          ...
          “Content”) are used under fair use for educational purposes. The Site
          and its contents are based in Spain and comply with applicable local
          and international laws regarding intellectual property.
        </p>
